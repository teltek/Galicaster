...
from galicaster.classui.listing import ListingClassUI, ArchiveUI
...
class Main():
    ...
    def load_modules(self):
        ...
        self.window.insert_page(self.recorder, 'RECORDER', REC)
        ...
        if 'media_manager' in self.modules:
            ...
            if 'archive' in self.modules:
                self.archive = ArchiveUI()
                self.window.insert_page(self.archive, 'ARCHIVE', ARCH)
