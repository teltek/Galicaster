...
#
#       tests/recorder/recorder_firewire_renc
#
...
"""
Tests for `galicaster.recorder.bins.firewire_renc` module.
"""
...
@attr('nodefault', 'recorder_firewire_renc')
class TestFunctions(TestCase, Base):

    firewire_renc_bin = [{'name'     : 'firewire_renc',
                     'device'   : 'firewire_renc',
                     'path'     :  '/tmp/',
                     'file'     : 'FIREWIRE_RENC.dv'}]
